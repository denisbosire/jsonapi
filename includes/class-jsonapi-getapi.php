...
class Get_Rest_Api
{
    ...
    public function jsonapi_page()
    {
        ...
        <div id="usercontent">
            <a href="#" class="bckbtn"><span
                        class="dashicons dashicons-arrow-left-alt"><?php esc_html_e('Back', 'jsonapi'); ?></span></a>
        ...
        <div id="content-area">
            ...
            <table class="data-table">
                ...
                <?php foreach ($arr_body as $value) { ?>
                    <tr>
                        <td><a href="#" data-userid="<?php echo $value['id']; ?>"
                               class="userid"><?php echo $value['id']; ?> </a></td>
                        <td><a href="#" data-userid="<?php echo $value['id']; ?>"
                               class="userid"><?php echo $value['name']; ?></a></td>
                        <td><a href="#" data-userid="<?php echo $value['id']; ?>"
                               class="userid"><?php echo $value['email']; ?></a></td>
                        <td><a href="#" data-userid="<?php echo $value['id']; ?>"
                               class="userid"><?php echo $value['username']; ?></a></td>
